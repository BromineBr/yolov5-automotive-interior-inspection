...
# todo 修改为你的数据的根目录
FILE_ROOT = "E:/shenghuo/tmp/lajiao/data/"
...
DEST_IMAGES_PATH = "lj_yolo_format/images"  # 区分训练集、测试集、验证集的图片目标路径
DEST_LABELS_PATH = "lj_yolo_format/labels"  # 区分训练集、测试集、验证集的标签文件目标路径
